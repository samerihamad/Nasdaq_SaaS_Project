...
value_for_key() {
  case "$1" in
    FAST_MIN_CONFIDENCE) echo "63" ;;
    GOLDEN_MIN_CONFIDENCE) echo "67" ;;
    FAST_MR_RSI_EXTREME_OVERSOLD) echo "30" ;;
    FAST_MR_RSI_EXTREME_OVERBOUGHT) echo "70" ;;
...
grep -E "^(FAST_MIN_CONFIDENCE|GOLDEN_MIN_CONFIDENCE|FAST_MR_RSI_EXTREME_OVERSOLD|FAST_MR_RSI_EXTREME_OVERBOUGHT|FAST_MOM_ADX_THRESHOLD|FAST_MOM_VOL_RATIO|FAST_MOM_VOL_RATIO_HIGH_RSI|FAST_MOM_RSI_VOL_TIER_HIGH|FAST_MOM_RSI_BUY_MAX|FAST_MOM_LOW_VOL_AI_MIN)=" "$ENV_FILE" || true
